  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={heroImage}
          alt="Modernes Schwimmbad mit kristallklarem Wasser"
      ...
      <div className="container relative z-10 px-4 pt-20 pb-12">
        ...
        >
          <motion.span
            ...
            className="inline-block px-4 py-1.5 mb-6 text-sm font-medium bg-secondary/90 text-secondary-foreground rounded-full backdrop-blur-sm"
          >
            Bald in Berlin-Tempelhof
          </motion.span>
          ...
          >
            Tempelhofer Hafen startet bald.
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-primary-foreground/90 mb-8 max-w-lg mx-auto"
          >
            Trag dich ein und erhalte Starttermin & Kursplätze zuerst.
          </motion.p>
