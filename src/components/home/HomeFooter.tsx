      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
        ...
        <div>
          ...
          <nav className="flex flex-col gap-2 text-sm text-slate-400">
            <Link to="/kurse/wassergewoehnung" onClick={scrollTop} className="hover:text-white transition-colors">Baby und Kleinkinder</Link>
        ...
        <div>
          ...
          <nav className="flex flex-col gap-2 text-sm text-slate-400">
            ...
            <Link to="/standorte" onClick={scrollTop} className="hover:text-white transition-colors font-medium">Alle Standorte</Link>
          </nav>
        </div>
