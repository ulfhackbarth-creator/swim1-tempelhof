...
const highlights = [
  {
    ...
    description: "Qualifizierte Schwimmlehrer mit jahrelanger Erfahrung",
  },
  {
    icon: MapPin,
    title: "Mehrere Standorte",
    description: "Etabliertes Netzwerk in Berlin",
  },
  {
    icon: ThumbsUp,
    title: "Qualitätsfokus",
    description: "Höchste Standards bei Sicherheit & Ausbildung",
  },
];
